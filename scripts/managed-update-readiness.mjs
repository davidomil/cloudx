...
export async function verifyHistoricalTerminals(release, dataDir) {
  ...
  const [{ TerminalReadiness }, { DurableTerminalProcessFactory, terminalSocketPath }, { NodePtyTerminalProcessFactory }] =
    await Promise.all([module("TerminalReadiness.js"), module("DurableTerminalProcess.js"), module("NodePtyTerminalProcess.js")]);
