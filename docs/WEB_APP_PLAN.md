...
- Loopback binding is a hard configuration invariant.
- Tailscale Serve is the recommended remote access path because Cloudx stays on localhost while tailnet identity and grants protect the public-facing edge.
