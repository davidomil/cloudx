  ...
  return [
    ...
    },
    {
      ...
      instructions: skillInstructions("Ingest", [
        ...
        "Imports can take several minutes or longer, especially with AI enrichment enabled. The helper uses the CloudX streaming hook when `CLOUDX_SERVER_URL` is set and waits for extraction and configured enrichment before returning a final result. Starting an import, receiving progress, or seeing an empty search result does not establish that ingestion has finished.",
